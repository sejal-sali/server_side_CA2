...
<p align="left">
  This website uses interactive theme and style to create, design and implement data. It connect to a MySQL database using a PDO connection, implement client-side form validation, utilise CSS and boostrap for styling and you will need to upload all files securely to a web server. It contains client-side validation in the HTML forms.
</p>
